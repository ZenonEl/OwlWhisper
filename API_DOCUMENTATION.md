...
**Последнее обновление:** 23 августа 2025 (Этап 1 базово завершен: удалены профили, добавлены сетевые методы, переименован GetPeers, исправлены критические баги)