# 📚 **Owl Whisper Core - API Documentation**
...
#### `AddProtectedPeer(peer_id: str) -> int`
...
**Возвращает:** JSON массив с кэшированными пирами или NULL при ошибке
