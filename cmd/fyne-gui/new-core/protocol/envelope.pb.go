...
func (x *SecureEnvelope) GetAuthorIdentity() *IdentityPublicKey {
	if x != nil {
...
func (x *SecureEnvelope) GetPayloadType() string {
	if x != nil {
...
func (x *SecureEnvelope) GetCiphertext() []byte {
	if x != nil {
		return x.Ciphertext
	}
	return nil
...
const file_envelope_proto_rawDesc = "" +
	"\n" +
	"\x0eenvelope.proto\x12\bprotocol\x1a\x0eidentity.proto\"\xaf\x01\n" +
	"\x0eSecureEnvelope\x12D\n" +
	...
	"ciphertext\x12\x14\n" +
	"\x05nonce\x18\x04 \x01(\fR\x05nonceB\x04Z\x02./b\x06proto3"
...
var file_envelope_proto_goTypes = []any{
	(*SecureEnvelope)(nil),    // 0: protocol.SecureEnvelope
	(*IdentityPublicKey)(nil), // 1: protocol.IdentityPublicKey
}
var file_envelope_proto_depIdxs = []int32{
	1, // 0: protocol.SecureEnvelope.author_identity:type_name -> protocol.IdentityPublicKey
